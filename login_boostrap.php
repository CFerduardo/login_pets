    ...
    <section class="">
        ...
        <div class="px-4 py-5 px-md-5 text-center text-lg-start" style="background-color: hsl(0, 0%, 96%)">
            ...
            <div class="row gx-lg-5 align-items-center">
                ...
                <p style="color: hsl(217, 10%, 50.8%)">
                    Registra tu mascota para saber su historial, si no estas registrado ingresa y goza de el mejor servicio
                </p>
        </div>
        ...
        <div class="col-lg-6 mb-5 mb-lg-0">
            ...
            <div class="card-body py-5 px-md-5">
                <form>
                <!-- 2 diseño de cuadrícula de columnas con entradas de texto para el nombre y apellido -->
                <div class="row">
                ...
                <!-- 2 diseño de cuadrícula de columnas con entradas de texto para el sexo y raza -->
                        ...
                        <div class="col-md-6 mb-4">
                            <div data-mdb-input-init class="form-outline">
                                <input type="text" id="form3Example2" class="form-control" />
                                <label class="form-label" for="form3Example2">Peso</label>
                            </div>
                        </div>
                </div>
                <!-- Checkbox -->
